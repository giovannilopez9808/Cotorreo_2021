...
\begin{frame}
    \misc{
        \begin{minipage}{0.48\linewidth}
            \begin{figure}[H]
                \centering
                \includegraphics[height=3.7cm,width=5.2cm]{sedema_web.png}
        ...
        \begin{minipage}{0.48\linewidth}
            \begin{figure}[H]
                \centering
                \includegraphics[height=3.7cm,width=5.2cm]{sima_web.png}
...
\begin{frame}
    \misc{
        \begin{minipage}{0.48\linewidth}
            \begin{figure}[H]
                \centering
                \includegraphics[width=5cm,height=4cm]{OMI_web}
        ...
        \begin{minipage}{0.48\linewidth}
            \begin{figure}[H]
                \centering
                \includegraphics[width=5cm,height=4cm]{data_web}
                \caption{Página web de los datos validados. \cite{Aura_page}}
            \end{figure}
        \end{minipage}
    }
\end{frame}
...
\begin{frame}
    ...
    \begin{minipage}{0.45\linewidth}
        \begin{figure}[H]
            \centering
            \includegraphics[width=5cm,height=3.7cm]{ozone_cdmx}
    ...
    \begin{minipage}{0.45\linewidth}
        \begin{figure}[H]
            \centering
            \includegraphics[width=5cm,height=3.7cm]{ozone_mty}
